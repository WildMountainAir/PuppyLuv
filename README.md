...
<h1 align="center"> Puppy Love </h1> <br>
<p align="center">
...
- Follow the [ReactJS Guide](https://reactjs.org/docs/getting-started.html) for getting started building a project with React.
- Clone or download the repo
- `npm` to install dependencies 
<br>
`npm install --save bootstrap react react-bootstrap @babel/cli @babel/core @babel/node @babel/register @babel/preset-env chai mocha nodemon
 eslint`
